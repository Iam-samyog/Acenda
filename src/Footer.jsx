        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white text-sm">Safety Information</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white text-sm">Cancellation options</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white text-sm">Community Blog</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white text-sm">Get in touch</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white text-sm">Partnerships</a></li>
            </ul>
          </div>
